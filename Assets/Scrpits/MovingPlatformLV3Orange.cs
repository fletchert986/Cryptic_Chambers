...
public class MovingPlatformLV3Orange : MonoBehaviour {
    ...
    public void FixedUpdate()
    {
        if (useCase == UseCase.Orange)
        {
            ...
            if (!_return && playerDetect) _platform.position = Vector3.MoveTowards(_platform.position, endPoint.position, _moveSpeed * Time.fixedDeltaTime);
        }
