	...
	public class ThirdPersonCharacter : MonoBehaviour
	{
        ...
        /*private void OnTriggerEnter(Collider other)
        {
            if (other.gameObject.CompareTag("Pick Up") || other.gameObject.CompareTag("Pick Up2") 
                || other.gameObject.CompareTag("Pick Up3") || other.gameObject.CompareTag("Pick Up4"))
            {
                ...
                else if (other.gameObject.CompareTag("Pick Up3"))
                {
                    lanternLight.color = Color.green;
                }
                else if (other.gameObject.CompareTag("Pick Up4"))
                {
